...
import com.app.lawyer.fragment.ClientCaseFragment;
import com.app.lawyer.fragment.MyRoleFragment;
...
//        drawer.closeDrawer(GravityCompat.START);
    ...
    public void initView() {
        ...
        drawer_customer_care = (CustomTextView) findViewById(R.id.drawer_customer_care);
        drawer_invite_friends = (CustomTextView) findViewById(R.id.drawer_invite_friends);
        drawer_feedback = (CustomTextView) findViewById(R.id.drawer_feedback);
...
//                startActivity(intent);
                drawer_btn_client_cases.setVisibility(View.GONE);
                ((CustomTextView) findViewById(R.id.toolbar_header)).setText(context.getResources().getString(R.string.menu_roll));
                MyRoleFragment youtubeFragment = new MyRoleFragment();
                displayFragment(youtubeFragment);
                break;
    ...
    protected void onResume() {
        ...
        if (!DataPrefrence.getPref(context, Constant.PROFILE_IMAGE, "").isEmpty())
        {
            ...
            Picasso.with(context).load(image_url).placeholder(R.drawable.amanrow_icons).error(R.drawable.amanrow_icons).into(drawer_prof_img);
//            Glide.with(context)
