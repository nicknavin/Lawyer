...
public class UseCase
{
    ...
    private String read_action_code;
    ...
    public String getRead_action_code() {
        return read_action_code;
    }

    public void setRead_action_code(String read_action_code) {
        this.read_action_code = read_action_code;
    }
