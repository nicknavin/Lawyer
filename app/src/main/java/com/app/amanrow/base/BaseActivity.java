...
import com.app.amanrow.utility.Methods;
import com.app.amanrow.utility.MyDialog;
...
//        }
       ...
       // lang = DataPrefrence.getPref(context, Constant.LANG_SELECTION, "");
        lang=DataPrefrence.getPref(context,Constant.LANG_SELECTION,"").toUpperCase();
        startTransition();
