 ...
 */
public class GenricAdapter extends RecyclerView.Adapter<GenricAdapter.ViewHolder> {
    ...
    public GenricAdapter(Context context)
    {
    ...
    @Override
    public void onBindViewHolder(@NonNull GenricAdapter.ViewHolder holder, int position)
    {
